        ...
        <div className="max-w-6xl mx-auto">
          <div className="bg-white rounded-lg shadow-2xl overflow-hidden">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
              ...
              <div className="relative bg-gradient-to-br from-primary/10 to-accent/10 p-6 md:p-12 flex items-center justify-center">
              ...
              <div className="p-6 md:p-12 flex flex-col justify-center">
                ...
                {/* Citação */}
                <div className="mt-6 md:mt-8 p-4 md:p-6 bg-gradient-to-r from-primary/5 to-accent/5 rounded-lg border-l-4 border-accent">
                  <p className="text-base md:text-lg text-stone-700 italic leading-relaxed">
